...
class PenaltyInfoTest {
    ...
    void shouldCreatePenaltyInfoWithAllFields() {
        PenaltyInfo penalty = PenaltyInfo.create(playerId, TeamSide.A, "Test reason", 3);
    ...
    void shouldNotTriggerSuspensionBelowThreshold() {
        PenaltyInfo penalty1 = PenaltyInfo.create(playerId, TeamSide.A, "Test", 1);
        PenaltyInfo penalty4 = PenaltyInfo.create(playerId, TeamSide.A, "Test", 4);
    ...
    void shouldTriggerSuspensionAtOrAboveThreshold() {
        PenaltyInfo penalty5 = PenaltyInfo.create(playerId, TeamSide.A, "Test", 5);
        PenaltyInfo penalty6 = PenaltyInfo.create(playerId, TeamSide.B, "Test", 6);
    ...
    void shouldWorkWithBothTeamSides() {
        PenaltyInfo homePenalty = PenaltyInfo.create(playerId, TeamSide.A, "Home foul", 2);
        PenaltyInfo awayPenalty = PenaltyInfo.create(playerId, TeamSide.B, "Away foul", 3);

        assertThat(homePenalty.teamSide()).isEqualTo(TeamSide.A);
        assertThat(awayPenalty.teamSide()).isEqualTo(TeamSide.B);
    }
}
